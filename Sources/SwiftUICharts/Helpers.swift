...
public struct Styles {
    public static func getDarkStyle(lightStyle: ChartStyle) -> ChartStyle {
        if lightStyle === Styles.barChartStyleOrangeLight {
            return Styles.barChartStyleOrangeDark
        } else if lightStyle === Styles.barChartMidnightGreenLight {
            return Styles.barChartMidnightGreenDark
        } else  if lightStyle === Styles.barChartStyleNeonBlueLight {
            return Styles.barChartStyleNeonBlueDark
        }
